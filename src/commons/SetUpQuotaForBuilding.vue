    ...
    <div class="row rw" style="margin-top: 15px;">
      ...
      <div class="col-xs-6" style="height:100%;display: flex;flex-flow:column;">
        <div class="box box-primary" style="flex:1;display: flex;flex-flow:column;">
          ...
          <div class="box-body" align="center" style="flex:1;display: flex;flex-flow:column;">
...
<script>
  ...
  export default {
    components: {
      SearchByYear,
      BarChart},
    name: "set-up-quota-for-building",
    data() {
      return {
        setUpDialog: false,
        width: '150px',
        ...
        itemColor:'#DD1C2C',//柱形图柱子颜色
        flag:false,
      }
    },
    created() {
      this.anyYear = this.dateFormat.getCurrentYear();
      this.buildingId = this.houseId;
      this.refresh();
    },
    props: {
      quotaData: {
