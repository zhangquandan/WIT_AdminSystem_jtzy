<template>
  <div style="height:100%;display:flex;flex-flow:column;">
    ...
    <tr>
      <td>
        <search-by-year :setWidth="width" @searchByYear="searchByYear" :currentYear="anyYear" :titleName="titleValue"
                        :searchName="searchName"></search-by-year>
      </td>
    ...
    <div class="row" style="margin-top: 15px;flex:1;">
      ...
      <div class="col-xs-6" style="height:100%;display: flex;flex-flow:column;">
        <div class="box box-primary" style="flex:1;display:flex;flex-flow:column;">
          ...
          <div class="box-body" align="center" style="flex:1;">
            <bar-chart :xData="xData" :yData="yData" :typeName="typeName"></bar-chart>
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-6" style="height:100%;">
        <div class="box box-primary" style="height: 100%;">
          ...
          <div class="box-footer" align="right" style="height:10%;">
  ...
  export default {
    ...
    methods: {
      ...
      refresh() {
        ...
        this.$api.deptQuota.findAll(params).then(res => {
          this.tableData = [];
          if(res == null || res == ''){
            this.status = 0 ;
            let obj = {};
      ...
      getQuotaData(){
        ...
        waterQuota.departmentid = this.departmentId ;
      ...
      keep(){
        this.$confirm('请确认是否保存当前部门年度定额?', '提示', {
          ...
          let departmentWaterquota = this.qs.stringify(this.getQuotaData());
          if(this.status == 0){
            this.$api.deptQuota.addDeptWaterQuota(departmentWaterquota).then(res => {
              if(res.msg == 'ok'){
            ...
            this.$api.deptQuota.updateDept(departmentWaterquota).then(res => {
              if(res.msg == 'ok'){
