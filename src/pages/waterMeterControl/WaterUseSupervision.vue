  ...
  <div class="flex">
    <div class="content body">
        ...
        <div class="box box-solid">
          ...
          <div class="box-body">
            <div class="water-charts-selectDate">
              <select-meter class="select-meter" @change="link" :meterId="meterId"></select-meter>
      ...
      <div class="water-table">
        <div class="box box-solid">
          <div class="box-header bg-aqua">水表用水监测数据<el-button size="mini" type="success" icon="el-icon-download" @click="exportData">导出</el-button></div>
          <div class="box-body">
...
<script>
  ...
  import WaterChartsLine from "./waterUseSupervision/waterChartsLine";
  import WaterTable from "./waterUseSupervision/WaterTable";
  ...
  export default {
    ...
    methods: {
      ...
      async findFlowByMonth() {
        ...
        let compare = await this.$api.waterMeterData.findTimesMonthFlow(params);
      ...
      async findFlowByDay() {
        ...
        params.starttime = this.compareStart;
        params.endtime = this.compareEnd;
        let compare = await this.$api.waterMeterData.findTimesDayFlow(params);
...
<style scoped>
  @import "../../../static/css/meterWaterUseSupervision.css";
</style>
