    ...
    <div class="content body">
      ...
      <div class="right">
        ...
        <div class="right-bottom box box-solid">
          ...
          <div class="box-body">
            <total-meter-table ref="total" @change="totalChange" :type="regionId" :totalFlow="totalFlow" v-show="active == 1"></total-meter-table>
            <son-meter-table ref="son" @change="subChange" :type="regionId" :subFlow="subFlow" v-show="active == 2"></son-meter-table>
          </div>
        </div>
        <!--right-top-->
...
<script>
  ...
  import BalanceTable from "./campusBalance/BalanceTable";
  import BalanceChart from "./campusBalance/BalanceChart";
  import TotalMeterTable from "./campusBalance/TotalMeterTable";
  import SonMeterTable from "./campusBalance/SonMeterTable";
  ...
  export default {
    ...
    methods: {
      ...
      changeCampus(params) {
        ...
        let param = {
          waterregionid : params.id
        };
        this.$refs.total.getTotalWaterMeter(param);
        this.$refs.son.getEndWaterMeter(param);
      },
      /*总分表信息表格切换*/
      changeType(type) {
        this.active = type;
