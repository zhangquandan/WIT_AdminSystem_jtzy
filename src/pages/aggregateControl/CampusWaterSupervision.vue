    ...
    <div class="content body">
      <div class="water-charts">
        ...
        <div class="box box-solid">
          <div class="box-header bg-aqua">校区用水监测图表</div>
          <div class="box-body">
            <div class="water-charts-select">
              <select-campus :regionId="regionId" @change="link" class="select-campus"></select-campus>
              <radio-select class="radio-select" @searchByTimes="searchByTimes"></radio-select>
            </div>
      ...
      <div class="water-table">
        <div class="box box-solid">
          <div class="box-header bg-aqua">校区用水监测数据<el-button size="mini" type="success" icon="el-icon-download" @click="exportData">导出</el-button></div>
          <div class="box-body">
...
<script>
    ...
    import WaterChartsLine from "./campusWaterSupervision/waterChartsLine";
    import WaterTable from "./campusWaterSupervision/WaterTable";
    ...
    export default {
      ...
      methods: {
        ...
        /*根据日期查询水量*/
        async findFlowByDay() { //数据请求同步化，方法前面加关键字 async
          this.show = false;
          this.showTable = false;
          let params = {
            pageNum: 1,
          ...
          let data = await this.$api.regionData.findTimesDayData(params); //请求接口前面加关键字await
          data = data && data.data && data.data.list && data.data.list.length > 0 ? data.data.list : false;
          data ? data.shift() : false;
...
<style scoped>
  @import "../../../static/css/campusWaterSupervision.css";
</style>
